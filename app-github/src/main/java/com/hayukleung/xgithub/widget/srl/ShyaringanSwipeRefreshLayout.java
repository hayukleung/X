...
public class ShyaringanSwipeRefreshLayout extends ViewGroup
  ...
  private Animation.AnimationListener mRefreshListener = new Animation.AnimationListener() {
    ...
    @SuppressLint("NewApi") @Override public void onAnimationEnd(Animation animation) {
      if (mRefreshing) {
  ...
  @SuppressLint("NewApi") private void startScaleUpAnimation(AnimationListener listener) {
  ...
  /**
   * Set a callback to override {@link ShyaringanSwipeRefreshLayout#canChildScrollUp()} method.
   * Non-null
  ...
  public interface OnChildScrollUpCallback {
    /**
     * Callback that will be called when {@link ShyaringanSwipeRefreshLayout#canChildScrollUp()}
     * method
