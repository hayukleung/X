...
public class MainActivity extends BaseActivity {
  ...
  @BindView(R.id.main_collapsing_toolbar) CollapsingToolbarLayout mCollapsingToolbarLayout;
  @BindView(R.id.main_appbar) AppBarLayout mAppBarLayout;

  @BindView(R.id.main_status_bar_stub) ViewStub mStatusBarStub;
  View mStatusBarOverlay;

  @BindView(R.id.main_drawer) LinearLayout mDrawer;
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    if (Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT) {
      ...
      mStatusBarOverlay.getViewTreeObserver()
  ...
  @OnClick(R.id.main_header) public void clickHeader() {
  ...
  private static class DummyAdapter extends RecyclerView.Adapter<DummyItemViewHolder> {
    ...
    @Override public DummyItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      final DummyItemViewHolder holder = new DummyItemViewHolder(
