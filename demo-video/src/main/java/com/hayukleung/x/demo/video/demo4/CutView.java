...
public class CutView extends View {
  ...
  private void init() {
    ...
    marginLeft = (int) getResources().getDimension(R.dimen.xp10_0);
    marginRight = (int) getResources().getDimension(R.dimen.xp10_0);
    marginTop = (int) getResources().getDimension(R.dimen.xp10_0);
    marginBottom = (int) getResources().getDimension(R.dimen.xp20_0);
    dp3 = (int) getResources().getDimension(R.dimen.xp3_0);
    dp1 = (int) getResources().getDimension(R.dimen.xp1_0);
