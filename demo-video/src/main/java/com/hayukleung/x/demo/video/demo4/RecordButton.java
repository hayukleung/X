...
import com.hayukleung.x.demo.video.BaseView;
 ...
 * 录制视频按钮
 */
public class RecordButton extends BaseView {

  boolean flag;
  private int measuredWidth = -1;
  private Paint paint;
  @ColorInt private int mColorGray;
  @ColorInt private int mColorBlue;
  ...
  protected void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    dp5 = (int) getResources().getDimension(R.dimen.xp6_0);
    mColorGray = ContextCompat.getColor(context, R.color.video_gray);
    mColorBlue = ContextCompat.getColor(context, R.color.video_blue);
    ...
    paintProgress.setColor(mColorBlue);
