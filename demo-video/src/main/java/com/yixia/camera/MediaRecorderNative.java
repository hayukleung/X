...
public class MediaRecorderNative extends MediaRecorderBase
  ...
  /** 开始录制 */
  @Override public MediaObject.MediaPart startRecord() {
    //防止没有初始化的情况
  ...
  @Override protected void onStartPreviewSuccess() {
    if (mCameraId == Camera.CameraInfo.CAMERA_FACING_BACK) {
      UtilityAdapter.RenderInputSettings(MediaRecorderBase.VIDEO_WIDTH,
          MediaRecorderBase.VIDEO_HEIGHT, 0, UtilityAdapter.FLIPTYPE_NORMAL);
    } else {
      UtilityAdapter.RenderInputSettings(MediaRecorderBase.VIDEO_WIDTH,
          MediaRecorderBase.VIDEO_HEIGHT, 180, UtilityAdapter.FLIPTYPE_HORIZONTAL);
    }
    UtilityAdapter.RenderOutputSettings(MediaRecorderBase.VIDEO_WIDTH,
        MediaRecorderBase.VIDEO_HEIGHT, mFrameRate,
        UtilityAdapter.OUTPUTFORMAT_YUV | UtilityAdapter.OUTPUTFORMAT_MASK_MP4 /*| UtilityAdapter.OUTPUTFORMAT_MASK_HARDWARE_ACC*/);
  }
