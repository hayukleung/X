...
import com.hayukleung.x.demo.vlayout.adapter.ScrollFixAdapter;
import org.androidannotations.annotations.AfterViews;
import org.androidannotations.annotations.EActivity;
import org.androidannotations.annotations.ViewById;

@EActivity(R.layout.recycler) public class FixLayoutActivity extends Activity {
  ...
  @AfterViews void afterviews() {
    ...
    adapter.addAdapter(
        new ScrollFixAdapter(this, new FixLayoutHelper(FixLayoutHelper.BOTTOM_LEFT, 200, 200),
            recycler));
